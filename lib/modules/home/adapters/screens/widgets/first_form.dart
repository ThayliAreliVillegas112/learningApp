...
import 'package:learning_app_10a/kernel/validations/validations_app.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: //me falta aqui el SingleChildScrollView
       Column(
        children: [
          Container(margin: const EdgeInsets.only(top: 16), child: Image.asset('assets/images/utez-logo.png', width: 300, height: 100,),),
          Form(
            key: _formKey,
            onChanged: (){
              setState(() {
